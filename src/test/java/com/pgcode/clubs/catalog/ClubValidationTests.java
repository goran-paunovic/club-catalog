...
class ClubValidationTests {
    ...
    @Test
    void whenAllFieldsAreCorrentValidationSucceeds() {
        ClubDto clubDto = new ClubDto( null, "name", null, null, null, null, "Country", null, null, null );
    ...
    void whenTitleIsBlankValidationFails() {
        ClubDto clubDto = new ClubDto( null, null, null, null, null, null, "Country", null, null, null );
